...
%
% Matrix to screw. 
% Extracts  from  a  rototranslation  matrix  Q the  parameters of the  screw 
% displacement  (axis u, rotation  angle phi, displacement h along u, a point 
